...
export default {
    ...
    data() {
        return {
            title: this.$t('prospect.convert.text'),
            object_types: [],
            prospect: {},
            customer: {},
            items: [
                ...
                {
                    text: this.$t('prospect.convert.text'),
                    active: true,
                },
            ],
            validationErrors: '',
    ...
    methods: {
        ...
        convertProspect() {
            ...
            this.$axios
                .post('api/prospects/' + this.$route.params.id + '/convert', this.prospect)
                .then(response => {
                    this.$bvModal.show('convertProspect')
...
<div>
    ...
    <div class="row">
        <div class="col-12">
          ...
          <form class="form-horizontal" role="form" @submit.prevent="convertProspect()">
          ...
          <div class="card">
                ...
                <div class="card-header bg-light">
                  ...
                  <div class="float-sm-right">
                    <input type="submit" :value="$t('prospect.convert.text')" class="btn btn-success">
                  </div>
                </div>
            ...
            <div class="card">
              ...
              <div class="card-header bg-warning">
                <h4 class="text-danger float-left">Nog toe te kennen velden</h4>
                <div class="float-sm-right">
                  <input type="submit" :value="$t('prospect.convert.text')" class="btn btn-success">
                </div>
              </div>
              ...
              <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <b-form-group class="col-md-6" :label="$t('object.object_id.text')" label-for="length">
                                <b-form-input for="length" v-model="prospect.object_id" :placeholder="$t('object.object_id.text')"></b-form-input>
                            </b-form-group>

                            <b-form-group class="col-md-6" :label="$t('object.spot.text')" label-for="length">
                                <b-form-input for="length" v-model="prospect.spot" :placeholder="$t('object.spot.text')"></b-form-input>
                            </b-form-group>

                        </div>

                  <b-modal id="convertProspect" :title="$t('global.success.text')">
