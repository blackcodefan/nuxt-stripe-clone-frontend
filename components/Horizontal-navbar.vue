                ...
                <div class="collapse navbar-collapse" id="topnav-menu-content">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown" v-for="(item, index) of menuItems" :key="index">
                            ...
                            <nuxt-link tag="a" v-if="!item.subItems && (!item.stripeCheck || ( item.stripeCheck && $auth.user.company.cashier_stripe_key )) " :to="item.link" class="nav-link dropdown-toggle arrow-none side-nav-link-ref">
